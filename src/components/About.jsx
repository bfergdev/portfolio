  ...
  const features = [
    {
      icon: Swords,
      title: 'Combat Design',
      description: 'Classes, Weapons, Character Progression, PVP Systems, Large-Scale Combat (Siege), Asymmetrical PVX Balance, CCC (Camera, Controls, Character), Mounts/Vehicles, PVE Enemies, Destructible Environments',
    },
    {
      icon: BarChart,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Combat & Systems Designer with a decade of experience shipping AAA Titles.
