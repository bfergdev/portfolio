  ...
  const projects = [
    {
      ...
      years: '2020 - 2025',
      flavorText: [
        'Owned Mage, Tank, and Ranger archetypes end-to-end — authored ability kits, skill trees, stat scaling, and class identity from concept through Alpha 2.',
        'Designed the full weapon system including 2H Spear, Dual Daggers, Book, and more — defining damage curves, attack speed, hybrid scaling, and proc/passive mechanics.',
        'Architected Node Siege systems: siege machines, vehicles, respawn safehouses, ballistas, destructible objectives, and conflict-driven PVP/PVX events.',
        'Designed the Corruption & Blight system and expanded open-world PVP through pillage events, buff shrines, and conflict objectives.',
    ...
    },
    {
      ...
      description: 'Combat and economy designer for a standalone PVP experience. Balanced dozens of weapons, armor sets, and combat items across thousands of spawners.',
      image: apocalypseImg,
      link: 'https://ashesofcreation.com/',
      ...
      years: '2019 - 2020',
      flavorText: [
        'Designed and balanced a full loot economy — item rarity tiers, drop rates, and spawner distribution across the battle royale map.',
        'Authored destructible item HP balance, compendium reward structures, and recovery analysis systems.',
        'Tuned storm speed pacing and loot pass progression to drive match tempo and player engagement.',
      ],
    },
    {
